...
class Config:
    ...
    cluster_mean_eoa_deg: Tuple[float, float, float] = (5.0, 0.0, -5.0)
    ...
    # Spatial constraint: <= 25Δ
    neighbor_radius_multiples_delta: float = 25.0
    ...
    ula_fixed_port_count: Optional[int] = 12
